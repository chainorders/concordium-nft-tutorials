//! CIS2 client is the intermediatory layer between contract and CIS2 contract.
//!
//! # Description
//! It allows contract to abstract away logic of calling CIS2 contract for the following methods
